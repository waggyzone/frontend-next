...
const Grommer = () => {
  ...
  const perPage = 5;
  const { data, isLoading, mutate } = Groomer.getAllGroomerByPage(skip, perPage);
...
Grommer.getLayout = (page: ReactElement) => <AdminLayout>{page}</AdminLayout>;

export default Grommer;
